  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        'inner-border': 'inset 0 1px 0 rgba(255, 255, 255, 0.1)'
      },
      backdropBlur: {
        xs: '2px'
      },
      backgroundImage: {
        ...
        'hero-pattern': 'radial-gradient(circle at 25% 25%, rgba(14, 165, 233, 0.2) 0%, transparent 50%), radial-gradient(circle at 75% 75%, rgba(217, 70, 239, 0.2) 0%, transparent 50%)'
      }
    }
  },
  plugins: []
